...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="income.php" class="<?= nav_active('income.php', $current) ?>"><span class="nav-ic"><img src="img/Income.png" alt="Income"></span> Income</a>
    ...
    <a href="savings.php" class="<?= nav_active('savings.php', $current) ?>"><span class="nav-ic"><img src="img/Savings.png" alt="Savings"></span> Savings</a>
